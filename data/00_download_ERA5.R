...
band = "mean_2m_air_temperature minimum_2m_air_temperature maximum_2m_air_temperature dewpoint_2m_temperature total_precipitation"
...
# save data
saveRDS(site_data, "data/ERA5.rds", compress = "xz")
